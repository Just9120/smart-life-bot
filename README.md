...
- [`docs/DEPLOYMENT.md`](docs/DEPLOYMENT.md) — базовые принципы деплоя, ограничения окружения и initial manual CD workflow через GitHub Actions (`workflow_dispatch`).
